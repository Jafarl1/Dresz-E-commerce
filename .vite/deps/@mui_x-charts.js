...
import {
  Typography_default
} from "./chunk-4BJRFMPT.js";
import "./chunk-JNGGNZPV.js";
import "./chunk-5CRRR5O4.js";
import {
  require_react_dom
...
var formatter4 = (params) => {
  ...
  seriesOrder.forEach((seriesId) => {
    ...
    defaultizedSeries[seriesId] = _extends({
      ...
      }, arcs[index2])).map((item) => {
        var _a, _b;
        return _extends({}, item, {
          formattedValue: ((_b = (_a = series[seriesId]).valueFormatter) == null ? void 0 : _b.call(_a, item)) ?? item.value.toLocaleString()
        });
      })
    });
  });
...
function CartesianContextProvider(props) {
  ...
  const drawingArea = React6.useContext(DrawingContext);
...
function ChartsGrid(props) {
  ...
  return (0, import_jsx_runtime18.jsxs)(GridRoot, _extends({}, other, {
    ...
    children: [vertical && xTicks.map(({
      formattedValue,
      offset
    }) => (0, import_jsx_runtime17.jsx)("line", {
      y1: yScale.range()[0],
      y2: yScale.range()[1],
      x1: offset,
      x2: offset,
...
var InteractionContext = React18.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React18.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React18.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
  return (0, import_jsx_runtime19.jsx)(InteractionContext.Provider, {
    value,
    children
  });
}
  ...
  return (0, import_jsx_runtime20.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime20.jsx)(ChartsTooltipTable, {
      ...
      children: (0, import_jsx_runtime20.jsx)("tbody", {
        children: (0, import_jsx_runtime21.jsxs)(ChartsTooltipRow, {
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime23.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime24.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime23.jsx)("thead", {
        children: (0, import_jsx_runtime23.jsx)(ChartsTooltipRow, {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime24.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime23.jsx)(ChartsTooltipCell, {
              ...
              className: clsx_default(classes.labelCell, classes.cell),
              children: label ? (0, import_jsx_runtime23.jsx)(Typography_default, {
                children: label
              }) : null
            }), (0, import_jsx_runtime23.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.valueCell, classes.cell),
...
function ChartsAxisTooltipContent(props) {
  ...
  const series = React23.useContext(SeriesContext);
...
function DefaultChartsLegend(props) {
  ...
  const labelStyle = React25.useMemo(
  ...
  const padding = React25.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React25.useCallback((label, inStyle = {}) => {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React25.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
function ChartsVoronoiHandler(props) {
  ...
  const {
    series,
    seriesOrder
  } = React28.useContext(SeriesContext).scatter ?? {};
  const voronoiRef = React28.useRef({});
  const delauneyRef = React28.useRef(void 0);
...
function ChartsOnAxisClickHandler(props) {
  ...
  const svgRef = React29.useContext(SvgContext);
  const series = React29.useContext(SeriesContext);
  const {
    axis
...
var HighlighContext = React32.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React32.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
  const value = React32.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
  return (0, import_jsx_runtime34.jsx)(HighlighContext.Provider, {
    value,
    children
  });
}
...
var useInteractionItemProps = (scope, skip) => {
  ...
  } = React33.useContext(HighlighContext);
  if (skip) {
    return () => ({});
  }
...
function BarElement(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(Bar, _extends({}, barProps));
}
...
var _excluded8 = ["skipAnimation", "onItemClick"];
...
var useAggregatedData = () => {
  const seriesData = React35.useContext(SeriesContext).bar ?? {
    series: {},
    stackingGroups: [],
    seriesOrder: []
  };
  const axisData = React35.useContext(CartesianContext);
  const {
    series,
    stackingGroups
  } = seriesData;
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime36.jsx)(React35.Fragment, {
    children: transition((style, {
      ...
      color: color2,
      highlightScope
    }) => (0, import_jsx_runtime36.jsx)(BarElement, _extends({
      id: seriesId,
      dataIndex,
      highlightScope,
      color: color2
...
var useAxisEvents = (disableAxisListener) => {
  const svgRef = React36.useContext(SvgContext);
  const {
    width,
    height,
    top,
...
var _excluded9 = ["children", "width", "height", "viewBox", "disableAxisListener", "className", "title", "desc"];
var ChartChartsSurfaceStyles = styled_default("svg", {
  name: "MuiChartsSurface",
  slot: "Root"
})(() => ({}));
var ChartsSurface = React37.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
  ...
  return (0, import_jsx_runtime38.jsxs)(ChartChartsSurfaceStyles, _extends({
    width,
    height,
    viewBox: `${svgView.x} ${svgView.y} ${svgView.width} ${svgView.height}`,
    ref
  }, other, {
    children: [(0, import_jsx_runtime37.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime37.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
var ChartContainer = React38.forwardRef(function ChartContainer2(props, ref) {
  const {
    width,
    height,
    series,
  ...
  useReducedMotion2();
  return (0, import_jsx_runtime39.jsx)(DrawingProvider, {
    width,
    height,
    margin,
    svgRef,
    children: (0, import_jsx_runtime39.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime39.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime39.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime39.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime39.jsx)(ChartsSurface, {
              width,
              height,
              ref: handleRef,
              sx,
...
var ResponsiveChartContainer = React40.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime40.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width && height ? (0, import_jsx_runtime40.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    })) : null
...
var BarChart = React41.forwardRef(function BarChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime42.jsxs)(ResponsiveChartContainer, {
    ref,
    ...
    children: [onAxisClick && (0, import_jsx_runtime41.jsx)(ChartsOnAxisClickHandler, {
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime41.jsx)(ChartsAxisHighlight, _extends({}, defaultizedAxisHighlight)), (0, import_jsx_runtime41.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
...
true ? BarChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types23.default.oneOfType([import_prop_types23.default.shape({
   ...
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types23.default.oneOfType([import_prop_types23.default.shape({
    axisId: import_prop_types23.default.oneOfType([import_prop_types23.default.number, import_prop_types23.default.string]),
    classes: import_prop_types23.default.object,
    disableLine: import_prop_types23.default.bool,
    disableTicks: import_prop_types23.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types23.default.oneOfType([import_prop_types23.default.shape({
    axisId: import_prop_types23.default.oneOfType([import_prop_types23.default.number, import_prop_types23.default.string]),
    classes: import_prop_types23.default.object,
    disableLine: import_prop_types23.default.bool,
    disableTicks: import_prop_types23.default.bool,
   ...
   * @default null
   */
  topAxis: import_prop_types23.default.oneOfType([import_prop_types23.default.shape({
    axisId: import_prop_types23.default.oneOfType([import_prop_types23.default.number, import_prop_types23.default.string]),
    classes: import_prop_types23.default.object,
    disableLine: import_prop_types23.default.bool,
    disableTicks: import_prop_types23.default.bool,
...
var useAnimatedPath = (path2, skipAnimation2) => {
  ...
  const interpolator = React42.useMemo(() => previousPath ? string_default(previousPath, path2) : () => path2, [previousPath, path2]);
  const {
    value
  } = useSpring({
    from: {
...
var _excluded11 = ["d", "skipAnimation", "ownerState"];
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime44.jsxs)(React43.Fragment, {
    children: [(0, import_jsx_runtime43.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime43.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top + height + bottom
      })
    }), (0, import_jsx_runtime43.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime43.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
var _excluded12 = ["id", "classes", "color", "highlightScope", "slots", "slotProps", "onClick"];
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime45.jsx)(Area, _extends({}, areaProps));
}
true ? AreaElement.propTypes = {
  ...
  d: import_prop_types25.default.string.isRequired,
  highlightScope: import_prop_types25.default.shape({
    faded: import_prop_types25.default.oneOf(["global", "none", "series"]),
    highlighted: import_prop_types25.default.oneOf(["item", "none", "series"])
  }),
...
var _excluded13 = ["slots", "slotProps", "onItemClick", "skipAnimation"];
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime46.jsx)("g", _extends({}, other, {
    children: completedData.reverse().map(({
      ...
      highlightScope,
      area
    }) => !!area && (0, import_jsx_runtime46.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color2,
      highlightScope,
...
var _excluded14 = ["d", "skipAnimation", "ownerState"];
...
function AnimatedLine(props) {
  ...
  const {
    ...
    right,
    chartId
  } = React46.useContext(DrawingContext);
  const path2 = useAnimatedPath(d, skipAnimation2);
  const {
    animatedWidth
  } = useSpring({
  ...
  return (0, import_jsx_runtime48.jsxs)(React46.Fragment, {
    children: [(0, import_jsx_runtime47.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime47.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top + height + bottom
      ...
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime47.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
var _excluded15 = ["id", "classes", "color", "highlightScope", "slots", "slotProps", "onClick"];
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime49.jsx)(Line, _extends({}, lineProps));
}
...
var useAggregatedData3 = () => {
  const seriesData = React48.useContext(SeriesContext).line;
  const axisData = React48.useContext(CartesianContext);
  if (seriesData === void 0) {
    return [];
  }
  const {
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime50.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime50.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color2,
        highlightScope,
...
var _excluded17 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "highlightScope", "onClick", "skipAnimation"];
...
MarkElementPath.propTypes = {
  ...
  ownerState: import_prop_types30.default.shape({
    ...
    id: import_prop_types30.default.string.isRequired,
...
function MarkElement(props) {
  ...
  const {
    item,
    axis
  } = React49.useContext(InteractionContext);
  ...
  return (0, import_jsx_runtime51.jsx)(MarkElementPath, _extends({}, other, {
    style: {
...
true ? MarkElement.propTypes = {
   ...
   */
  shape: import_prop_types30.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired,
  /**
   * If `true`, animations are skipped.
   * @default false
   */
...
var _excluded18 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
function MarkPlot(props) {
  ...
  const seriesData = React50.useContext(SeriesContext).line;
  const axisData = React50.useContext(CartesianContext);
  const {
    chartId
  } = React50.useContext(DrawingContext);
  ...
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
  return (0, import_jsx_runtime52.jsx)("g", _extends({}, other, {
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime52.jsx)("g", {
          ...
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime52.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
              color: series[seriesId].color,
...
var _excluded19 = ["x", "y", "id", "classes", "color"];
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime53.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
...
function LineHighlightPlot(props) {
  ...
  const seriesData = React52.useContext(SeriesContext).line;
  const axisData = React52.useContext(CartesianContext);
  const {
    axis
  ...
  return (0, import_jsx_runtime54.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        return (0, import_jsx_runtime54.jsx)(Element, _extends({
          id: seriesId,
          color: series[seriesId].color,
          x: x2,
          y: y2
...
var LineChart = React53.forwardRef(function LineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  const id = useId();
  const clipPathId = `${id}-clip-path`;
  return (0, import_jsx_runtime56.jsxs)(ResponsiveChartContainer, {
    ref,
    series: series.map((s2) => _extends({
    ...
    sx,
    disableAxisListener: (tooltip == null ? void 0 : tooltip.trigger) !== "axis" && (axisHighlight == null ? void 0 : axisHighlight.x) === "none" && (axisHighlight == null ? void 0 : axisHighlight.y) === "none" && !onAxisClick,
    children: [onAxisClick && (0, import_jsx_runtime55.jsx)(ChartsOnAxisClickHandler, {
      onAxisClick
    }), grid && (0, import_jsx_runtime55.jsx)(ChartsGrid, {
      vertical: grid.vertical,
      horizontal: grid.horizontal
    }), (0, import_jsx_runtime56.jsxs)("g", {
      clipPath: `url(#${clipPathId})`,
      children: [(0, import_jsx_runtime55.jsx)(AreaPlot, {
        slots,
        slotProps,
        onItemClick: onAreaClick,
        skipAnimation: skipAnimation2
      }), (0, import_jsx_runtime55.jsx)(LinePlot, {
        slots,
        slotProps,
        onItemClick: onLineClick,
        skipAnimation: skipAnimation2
      })]
    }), (0, import_jsx_runtime55.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime55.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime55.jsx)(MarkPlot, {
      slots,
      slotProps,
      onItemClick: onMarkClick,
      skipAnimation: skipAnimation2
    }), (0, import_jsx_runtime55.jsx)(LineHighlightPlot, {
      slots,
      slotProps
    }), (0, import_jsx_runtime55.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime55.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime55.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
true ? LineChart.propTypes = {
  ...
  bottomAxis: import_prop_types34.default.oneOfType([import_prop_types34.default.shape({
    ...
    tickLabelPlacement: import_prop_types34.default.oneOf(["middle", "tick"]),
    ...
    tickPlacement: import_prop_types34.default.oneOf(["end", "extremities", "middle", "start"]),
   ...
   */
  disableLineItemHighlight: import_prop_types34.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types34.default.shape({
    horizontal: import_prop_types34.default.bool,
   ...
   */
  onAreaClick: import_prop_types34.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   * @param {null | AxisData} data The data about the clicked axis and items associated with it.
   */
  onAxisClick: import_prop_types34.default.func,
  /**
   * Callback fired when a line element is clicked.
   */
  onLineClick: import_prop_types34.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types34.default.func,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
...
var _excluded21 = ["classes", "color", "cornerRadius", "dataIndex", "endAngle", "highlightScope", "id", "innerRadius", "isFaded", "isHighlighted", "onClick", "outerRadius", "paddingAngle", "startAngle"];
...
function PieArc(props) {
  ...
  const getInteractionItemProps = useInteractionItemProps(highlightScope);
  return (0, import_jsx_runtime57.jsx)(PieArcRoot, _extends({
...
true ? PieArc.propTypes = {
  ...
  isFaded: import_prop_types35.default.bool.isRequired,
  isHighlighted: import_prop_types35.default.bool.isRequired
} : void 0;
...
function useTransformData(series) {
  ...
  const getHighlightStatus = React55.useCallback((dataIndex) => {
  ...
  const dataWithHighlight = React55.useMemo(() => data.map((item, itemIndex) => {
    const {
      isHighlighted,
      isFaded
...
var _excluded23 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "onItemClick", "skipAnimation"];
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime58.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index2) => {
      ...
      return (0, import_jsx_runtime58.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcPlot.propTypes = {
   ...
   */
  arcLabelRadius: import_prop_types36.default.number,
  /**
   * The radius applied to arc corners (similar to border radius).
   * @default 0
   */
  cornerRadius: import_prop_types36.default.number,
  data: import_prop_types36.default.arrayOf(import_prop_types36.default.shape({
    color: import_prop_types36.default.string.isRequired,
    endAngle: import_prop_types36.default.number.isRequired,
    formattedValue: import_prop_types36.default.string.isRequired,
    ...
    padAngle: import_prop_types36.default.number.isRequired,
    startAngle: import_prop_types36.default.number.isRequired,
   ...
   */
  faded: import_prop_types36.default.shape({
    additionalRadius: import_prop_types36.default.number,
    arcLabelRadius: import_prop_types36.default.number,
    color: import_prop_types36.default.string,
    cornerRadius: import_prop_types36.default.number,
    innerRadius: import_prop_types36.default.number,
    outerRadius: import_prop_types36.default.number,
    paddingAngle: import_prop_types36.default.number
  }),
  /**
   * Override the arc attibutes when it is highlighted.
   */
  highlighted: import_prop_types36.default.shape({
    additionalRadius: import_prop_types36.default.number,
    arcLabelRadius: import_prop_types36.default.number,
    color: import_prop_types36.default.string,
    cornerRadius: import_prop_types36.default.number,
  ...
  highlightScope: import_prop_types36.default.shape({
    faded: import_prop_types36.default.oneOf(["global", "none", "series"]),
    highlighted: import_prop_types36.default.oneOf(["item", "none", "series"])
  }),
  id: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]).isRequired,
  /**
   ...
   */
  outerRadius: import_prop_types36.default.number.isRequired,
  /**
...
var _excluded25 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime59.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
true ? PieArcLabel.propTypes = {
  ...
  formattedArcLabel: import_prop_types37.default.string,
  ...
  isFaded: import_prop_types37.default.bool.isRequired,
  isHighlighted: import_prop_types37.default.bool.isRequired
} : void 0;

// node_modules/@mui/x-charts/esm/PieChart/PieArcLabelPlot.js
var import_jsx_runtime60 = __toESM(require_jsx_runtime());
var _excluded26 = ["arcLabel", "arcLabelMinAngle", "arcLabelRadius", "cornerRadius", "data", "faded", "highlighted", "highlightScope", "id", "innerRadius", "outerRadius", "paddingAngle", "skipAnimation", "slotProps", "slots"];
var _excluded27 = ["startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "arcLabelRadius", "cornerRadius"];
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime60.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      let {
        ...
        arcLabelRadius: aLR,
        cornerRadius: cR
      } = _ref, style = _objectWithoutPropertiesLoose(_ref, _excluded27);
      return (0, import_jsx_runtime60.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcLabelPlot.propTypes = {
   ...
   */
  arcLabel: import_prop_types38.default.oneOfType([import_prop_types38.default.oneOf(["formattedValue", "label", "value"]), import_prop_types38.default.func]),
  /**
   * The minimal angle required to display the arc label.
   * @default 0
   */
  arcLabelMinAngle: import_prop_types38.default.number,
  /**
   * The radius between circle center and the arc label in px.
   * @default (innerRadius - outerRadius) / 2
   */
  arcLabelRadius: import_prop_types38.default.number,
  /**
   * The radius applied to arc corners (similar to border radius).
   * @default 0
   */
  cornerRadius: import_prop_types38.default.number,
  data: import_prop_types38.default.arrayOf(import_prop_types38.default.shape({
    color: import_prop_types38.default.string.isRequired,
    endAngle: import_prop_types38.default.number.isRequired,
    formattedValue: import_prop_types38.default.string.isRequired,
    ...
    padAngle: import_prop_types38.default.number.isRequired,
    startAngle: import_prop_types38.default.number.isRequired,
   ...
   * @default { additionalRadius: -5 }
   */
  faded: import_prop_types38.default.shape({
    additionalRadius: import_prop_types38.default.number,
    arcLabelRadius: import_prop_types38.default.number,
    color: import_prop_types38.default.string,
    cornerRadius: import_prop_types38.default.number,
    innerRadius: import_prop_types38.default.number,
    outerRadius: import_prop_types38.default.number,
    paddingAngle: import_prop_types38.default.number
  }),
  /**
   * Override the arc attibutes when it is highlighted.
   */
  highlighted: import_prop_types38.default.shape({
    additionalRadius: import_prop_types38.default.number,
    arcLabelRadius: import_prop_types38.default.number,
    color: import_prop_types38.default.string,
    cornerRadius: import_prop_types38.default.number,
   ...
   * The radius between circle center and the end of the arc.
   */
  outerRadius: import_prop_types38.default.number.isRequired,
  /**
   * The padding angle (deg) between two arcs.
   * @default 0
   */
...
function PiePlot(props) {
  ...
  const seriesData = React59.useContext(SeriesContext).pie;
  const {
    left,
    top,
    width,
    height
  } = React59.useContext(DrawingContext);
  if (seriesData === void 0) {
    return null;
  }
  ...
  return (0, import_jsx_runtime62.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime61.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime61.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime61.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime61.jsx)(PieArcLabelPlot, {
          innerRadius,
...
function PieChart(props) {
  ...
  return (0, import_jsx_runtime64.jsxs)(ResponsiveChartContainer, {
    series: series.map((s2) => _extends({
      type: "pie"
    }, s2)),
    width,
    ...
    children: [(0, import_jsx_runtime63.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime63.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick,
      skipAnimation: skipAnimation2
    }), (0, import_jsx_runtime63.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime63.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime63.jsx)(ChartsTooltip, _extends({}, tooltip)), children]
  });
}
true ? PieChart.propTypes = {
   ...
   */
  axisHighlight: import_prop_types40.default.shape({
   ...
   * @default null
   */
  bottomAxis: import_prop_types40.default.oneOfType([import_prop_types40.default.shape({
    ...
    disableLine: import_prop_types40.default.bool,
    disableTicks: import_prop_types40.default.bool,
    fill: import_prop_types40.default.string,
    label: import_prop_types40.default.string,
    labelFontSize: import_prop_types40.default.number,
    ...
    stroke: import_prop_types40.default.string,
    tickFontSize: import_prop_types40.default.number,
    tickInterval: import_prop_types40.default.oneOfType([import_prop_types40.default.oneOf(["auto"]), import_prop_types40.default.array, import_prop_types40.default.func]),
    tickLabelInterval: import_prop_types40.default.oneOfType([import_prop_types40.default.oneOf(["auto"]), import_prop_types40.default.func]),
    tickLabelPlacement: import_prop_types40.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types40.default.object,
    tickMaxStep: import_prop_types40.default.number,
    tickMinStep: import_prop_types40.default.number,
    tickNumber: import_prop_types40.default.number,
    tickPlacement: import_prop_types40.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types40.default.number
   ...
   * @default blueberryTwilightPalette
   */
  colors: import_prop_types40.default.oneOfType([import_prop_types40.default.arrayOf(import_prop_types40.default.string), import_prop_types40.default.func]),
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types40.default.arrayOf(import_prop_types40.default.object),
   ...
   * @default false
   */
  disableAxisListener: import_prop_types40.default.bool,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default null
   */
  leftAxis: import_prop_types40.default.oneOfType([import_prop_types40.default.shape({
    axisId: import_prop_types40.default.oneOfType([import_prop_types40.default.number, import_prop_types40.default.string]),
    classes: import_prop_types40.default.object,
    disableLine: import_prop_types40.default.bool,
    disableTicks: import_prop_types40.default.bool,
    ...
    labelFontSize: import_prop_types40.default.number,
    labelStyle: import_prop_types40.default.object,
    position: import_prop_types40.default.oneOf(["left", "right"]),
    slotProps: import_prop_types40.default.object,
    slots: import_prop_types40.default.object,
    stroke: import_prop_types40.default.string,
    tickFontSize: import_prop_types40.default.number,
   ...
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types40.default.shape({
    classes: import_prop_types40.default.object,
    direction: import_prop_types40.default.oneOf(["column", "row"]),
   ...
   * @default object Depends on the charts type.
   */
  margin: import_prop_types40.default.shape({
   ...
   * @default null
   */
  rightAxis: import_prop_types40.default.oneOfType([import_prop_types40.default.shape({
    axisId: import_prop_types40.default.oneOfType([import_prop_types40.default.number, import_prop_types40.default.string]),
    classes: import_prop_types40.default.object,
    disableLine: import_prop_types40.default.bool,
    disableTicks: import_prop_types40.default.bool,
   ...
   */
  series: import_prop_types40.default.arrayOf(import_prop_types40.default.object).isRequired,
  /**
   * If `true`, animations are skipped.
   * @default false
   */
   ...
   * @default { trigger: 'item' }
   */
  tooltip: import_prop_types40.default.shape({
    axisContent: import_prop_types40.default.elementType,
    classes: import_prop_types40.default.object,
    itemContent: import_prop_types40.default.elementType,
    slotProps: import_prop_types40.default.object,
    slots: import_prop_types40.default.object,
    trigger: import_prop_types40.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types40.default.oneOfType([import_prop_types40.default.shape({
    axisId: import_prop_types40.default.oneOfType([import_prop_types40.default.number, import_prop_types40.default.string]),
    classes: import_prop_types40.default.object,
    disableLine: import_prop_types40.default.bool,
    disableTicks: import_prop_types40.default.bool,
  ...
  viewBox: import_prop_types40.default.shape({
    height: import_prop_types40.default.number,
    width: import_prop_types40.default.number,
    x: import_prop_types40.default.number,
    y: import_prop_types40.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
   ...
   * If not provided, a default axis config is used with id set to `DEFAULT_X_AXIS_KEY`.
   */
  xAxis: import_prop_types40.default.arrayOf(import_prop_types40.default.shape({
    axisId: import_prop_types40.default.oneOfType([import_prop_types40.default.number, import_prop_types40.default.string]),
    classes: import_prop_types40.default.object,
    data: import_prop_types40.default.array,
    dataKey: import_prop_types40.default.string,
    disableLine: import_prop_types40.default.bool,
    disableTicks: import_prop_types40.default.bool,
    fill: import_prop_types40.default.string,
    hideTooltip: import_prop_types40.default.bool,
    id: import_prop_types40.default.oneOfType([import_prop_types40.default.number, import_prop_types40.default.string]),
    label: import_prop_types40.default.string,
    labelFontSize: import_prop_types40.default.number,
    labelStyle: import_prop_types40.default.object,
    max: import_prop_types40.default.oneOfType([import_prop_types40.default.instanceOf(Date), import_prop_types40.default.number]),
    min: import_prop_types40.default.oneOfType([import_prop_types40.default.instanceOf(Date), import_prop_types40.default.number]),
    position: import_prop_types40.default.oneOf(["bottom", "left", "right", "top"]),
    reverse: import_prop_types40.default.bool,
    scaleType: import_prop_types40.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types40.default.object,
    slots: import_prop_types40.default.object,
    stroke: import_prop_types40.default.string,
    tickFontSize: import_prop_types40.default.number,
    ...
    tickPlacement: import_prop_types40.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types40.default.number,
    valueFormatter: import_prop_types40.default.func
  })),
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used with id set to `DEFAULT_Y_AXIS_KEY`.
   */
  yAxis: import_prop_types40.default.arrayOf(import_prop_types40.default.shape({
    axisId: import_prop_types40.default.oneOfType([import_prop_types40.default.number, import_prop_types40.default.string]),
    classes: import_prop_types40.default.object,
    data: import_prop_types40.default.array,
    dataKey: import_prop_types40.default.string,
...
function Scatter(props) {
  ...
  const highlightScope = React61.useMemo(() => _extends({
    highlighted: "item",
    faded: "global"
  ...
  const cleanData = React61.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
  ...
  return (0, import_jsx_runtime65.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime65.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
...
true ? Scatter.propTypes = {
  ...
  markerSize: import_prop_types41.default.number.isRequired,
  /**
   * Callback fired when clicking on a scatter item.
  ...
  series: import_prop_types41.default.object.isRequired,
  xScale: import_prop_types41.default.func.isRequired,
  yScale: import_prop_types41.default.func.isRequired
} : void 0;
...
function ScatterPlot(props) {
  ...
  const seriesData = React62.useContext(SeriesContext).scatter;
  ...
  return (0, import_jsx_runtime66.jsx)(React62.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
      ...
      const xScale = xAxis[xAxisKey ?? defaultXAxisId].scale;
      const yScale = yAxis[yAxisKey ?? defaultYAxisId].scale;
      return (0, import_jsx_runtime66.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color: color2,
...
var ScatterChart = React63.forwardRef(function ScatterChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime68.jsxs)(ResponsiveChartContainer, {
    ref,
    series: series.map((s2) => _extends({
      type: "scatter"
    }, s2)),
    ...
    yAxis,
    sx,
    children: [!disableVoronoi && (0, import_jsx_runtime67.jsx)(ChartsVoronoiHandler, {
      voronoiMaxRadius,
      onItemClick
    }), (0, import_jsx_runtime67.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), grid && (0, import_jsx_runtime67.jsx)(ChartsGrid, {
      vertical: grid.vertical,
      horizontal: grid.horizontal
    }), (0, import_jsx_runtime67.jsx)(ScatterPlot, {
      slots,
      slotProps,
      onItemClick: disableVoronoi ? onItemClick : void 0
    }), (0, import_jsx_runtime67.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime67.jsx)(ChartsAxisHighlight, _extends({
      x: "none",
      y: "none"
    }, axisHighlight)), (0, import_jsx_runtime67.jsx)(ChartsTooltip, _extends({
      trigger: "item"
    }, tooltip)), children]
  });
});
true ? ScatterChart.propTypes = {
   ...
   * @default false
   */
  disableVoronoi: import_prop_types43.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types43.default.shape({
   ...
   * If `undefined`, the radius is assumed to be infinite.
   */
  voronoiMaxRadius: import_prop_types43.default.number,
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
  width: import_prop_types43.default.number,
...
var SparkLineChart = React64.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    width,
    height,
  ...
  return (0, import_jsx_runtime70.jsxs)(ResponsiveChartContainer, {
    ref,
    series: [_extends({
      type: plotType,
      data,
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime69.jsx)(BarPlot, {
      skipAnimation: true,
      slots,
      slotProps,
      sx: {
    ...
    }), plotType === "line" && (0, import_jsx_runtime70.jsxs)(React64.Fragment, {
      children: [(0, import_jsx_runtime69.jsx)(AreaPlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime69.jsx)(LinePlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime69.jsx)(LineHighlightPlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime69.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime69.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  });
...
true ? SparkLineChart.propTypes = {
   ...
   * @default false
   */
  area: import_prop_types44.default.bool,
   ...
   * @default 'linear'
   */
  curve: import_prop_types44.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
  /**
   * Data to plot.
   */
  data: import_prop_types44.default.arrayOf(import_prop_types44.default.number).isRequired,
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
   ...
   * @default 'line'
   */
  plotType: import_prop_types44.default.oneOf(["bar", "line"]),
  /**
   ...
   * @default false
   */
  showHighlight: import_prop_types44.default.bool,
  /**
   * Set to `true` to enable the tooltip in the sparkline.
   * @default false
   */
  showTooltip: import_prop_types44.default.bool,
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   */
  xAxis: import_prop_types44.default.shape({
...
var GaugeContext = React65.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function GaugeProvider(props) {
  ...
  return (0, import_jsx_runtime71.jsx)(GaugeContext.Provider, {
    value: contextValue,
    children
  });
}
function useGaugeState() {
  return React65.useContext(GaugeContext);
}

// node_modules/@mui/x-charts/esm/Gauge/GaugeContainer.js
var import_jsx_runtime72 = __toESM(require_jsx_runtime());
var _excluded28 = ["width", "height", "margin", "title", "desc", "value", "valueMin", "valueMax", "startAngle", "endAngle", "outerRadius", "innerRadius", "cornerRadius", "cx", "cy", "children"];
...
var GaugeContainer = React66.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
  ...
  const [containerRef, width, height] = useChartContainerDimensions(inWidth, inHeight);
  const svgRef = React66.useRef(null);
  const handleRef = useForkRef(ref, svgRef);
  return (0, import_jsx_runtime72.jsx)(ResizableContainer2, _extends({
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    ...
    children: width && height ? (0, import_jsx_runtime72.jsx)(DrawingProvider, {
      width,
      height,
      margin: _extends({
        left: 10,
      ...
      svgRef,
      children: (0, import_jsx_runtime72.jsx)(GaugeProvider, {
        value,
        valueMin,
        valueMax,
        startAngle,
        ...
        cx,
        cy,
        children: (0, import_jsx_runtime72.jsx)(ChartsSurface, {
          width,
          height,
          ref: handleRef,
          title,
...
true ? GaugeContainer.propTypes = {
   ...
   * @default 0
   */
  cornerRadius: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
  /**
   * The x coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the width the drawing area.
   */
  cx: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
  /**
   * The y coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the height the drawing area.
   */
  cy: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
   ...
   * @default 360
   */
  endAngle: import_prop_types45.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default '80%'
   */
  innerRadius: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   * Accepts an object with the optional properties: `top`, `bottom`, `left`, and `right`.
   ...
   * @default '100%'
   */
  outerRadius: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
  /**
   * The start angle (deg).
   * @default 0
   */
  startAngle: import_prop_types45.default.number,
   ...
   * @default 100
   */
  valueMax: import_prop_types45.default.number,
  /**
   * The minimal value of the gauge.
   * @default 0
   */
  valueMin: import_prop_types45.default.number,
...
function GaugeValueArc(props) {
  ...
  return (0, import_jsx_runtime73.jsx)(StyledPath, _extends({
...
function GaugeReferenceArc(props) {
  ...
  return (0, import_jsx_runtime74.jsx)(StyledPath2, _extends({
    transform: `translate(${cx}, ${cy})`,
    d: arc_default().cornerRadius(cornerRadius)({
      startAngle,
      endAngle,
...
var _excluded29 = ["text", "className"];
...
function GaugeValueText(props) {
  ...
  return (0, import_jsx_runtime75.jsx)("g", {
    className,
    children: (0, import_jsx_runtime75.jsx)(ChartsText, _extends({
      x: cx,
      y: cy,
      text: formattedText,
      style: {
...
true ? GaugeValueText.propTypes = {
   ...
   * Height of a text line (in `em`).
   */
  lineHeight: import_prop_types46.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types46.default.bool,
  ownerState: import_prop_types46.default.any,
  /**
   * Style applied to text elements.
   */
  style: import_prop_types46.default.object,
  text: import_prop_types46.default.oneOfType([import_prop_types46.default.func, import_prop_types46.default.string])
} : void 0;

// node_modules/@mui/x-charts/esm/Gauge/Gauge.js
var import_jsx_runtime76 = __toESM(require_jsx_runtime());
var import_jsx_runtime77 = __toESM(require_jsx_runtime());
var _excluded30 = ["text", "children", "classes"];
...
function Gauge(props) {
  ...
  return (0, import_jsx_runtime77.jsxs)(GaugeContainer, _extends({}, other, {
    className: classes.root,
    children: [(0, import_jsx_runtime76.jsx)(GaugeReferenceArc, {
      className: classes.referenceArc
    }), (0, import_jsx_runtime76.jsx)(GaugeValueArc, {
      className: classes.valueArc
    }), (0, import_jsx_runtime76.jsx)(GaugeValueText, {
...
true ? Gauge.propTypes = {
   ...
   * @default 0
   */
  cornerRadius: import_prop_types47.default.oneOfType([import_prop_types47.default.number, import_prop_types47.default.string]),
  /**
   * The x coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the width the drawing area.
   */
  cx: import_prop_types47.default.oneOfType([import_prop_types47.default.number, import_prop_types47.default.string]),
  /**
   * The y coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the height the drawing area.
   */
  cy: import_prop_types47.default.oneOfType([import_prop_types47.default.number, import_prop_types47.default.string]),
   ...
   * @default 360
   */
  endAngle: import_prop_types47.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default '80%'
   */
  innerRadius: import_prop_types47.default.oneOfType([import_prop_types47.default.number, import_prop_types47.default.string]),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   * Accepts an object with the optional properties: `top`, `bottom`, `left`, and `right`.
   ...
   * @default '100%'
   */
  outerRadius: import_prop_types47.default.oneOfType([import_prop_types47.default.number, import_prop_types47.default.string]),
  /**
   * The start angle (deg).
   * @default 0
   */
  startAngle: import_prop_types47.default.number,
  sx: import_prop_types47.default.oneOfType([import_prop_types47.default.arrayOf(import_prop_types47.default.oneOfType([import_prop_types47.default.func, import_prop_types47.default.object, import_prop_types47.default.bool])), import_prop_types47.default.func, import_prop_types47.default.object]),
  text: import_prop_types47.default.oneOfType([import_prop_types47.default.func, import_prop_types47.default.string]),
   ...
   * @default 100
   */
  valueMax: import_prop_types47.default.number,
  /**
   * The minimal value of the gauge.
   * @default 0
   */
  valueMin: import_prop_types47.default.number,
